/*
 * Glue Project: C# Implementation of Markdown markup by John Gruber
 * 
...
namespace Glue.Lib.Text
{
	...
	{
        public static readonly Markdown Default = new Markdown();
        ...
        public string Process(string text)
        {
            ...
            // 2007-05-21: Disabled to provide multiple white lines by entering
            //   <space><space><lf>
            //   <space><space><lf>
            // TODO: Check if this one does'nt interfere with rest of formatting
        ...
        {
            // <strong> must go first, pattern is '**':
            //text = Regex.Replace (text, @"(\*\*) (?=\S) (.+?[*_]*) (?<=\S) \1",   // alleen **geen spaties** 
            text = Regex.Replace (text, @"(\*\*) (.+?[*_]*) \1",                    // ** spaties ** toegestaan
                new MatchEvaluator (BoldEvaluator),
                RegexOptions.IgnorePatternWhitespace | RegexOptions.Singleline);
            
            // <u> is for __underline__
            //text = Regex.Replace (text, @"(__) (?=\S) (.+?[*_]*) (?<=\S) \1", 
            text = Regex.Replace (text, @"(__) (.+?[*_]*) \1",
                                  new MatchEvaluator (UnderlineEvaluator),
                                  RegexOptions.IgnorePatternWhitespace | RegexOptions.Singleline);
        ...
        private string UnderlineEvaluator (Match match)
        {
            return string.Format ("<u>{0}</u>", match.Groups[2].Value);
        }
